...
let openContainer = "height: 100vh; transition: all 0.3s ease 0s;";
let closeContainer = "height: 0px; transition: all 0.3s ease 0s;";
...
let line__2_style_open = "transition: 0s; opacity: 0";

//close mobil menu style
let line__1_style_close = "transition: .3s ;transform: rotate(0deg) translate(0px, 0px)";
let line__3_style_close = "transition: .3s ;transform: rotate(0deg) translate(0px, 0px)";
let line__2_style_close = "transition: .6s; opacity: 1";
